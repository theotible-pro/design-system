...
import { st as definePreviewAddon10 } from "./components-Bx1NfOne.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-DjJXPnDf.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-ykXIgavA.js");
