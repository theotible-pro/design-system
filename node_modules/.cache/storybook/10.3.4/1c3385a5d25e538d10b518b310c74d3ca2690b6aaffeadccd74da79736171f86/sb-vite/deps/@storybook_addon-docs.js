...
import { st as definePreviewAddon10 } from "./components-dqS3B2UU.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-DmG51u6N.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-COX--UcN.js");
